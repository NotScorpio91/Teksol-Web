    ...
    <header className="flex justify-center   items-center select-none ">
      <nav className="flex flex-row justify-between px-4 sm:px-10   sm:justify-around items-center w-full  sm:w-[1536px] h-[64px] bg-black bg-opacity-50 fixed top-0  backdrop-blur-[12px] z-10   ">
        <div className="flex lg:flex-1 z-50">
          <a href="/">
            <Logo className="w-20 sm:w-[110px] sm:hidden" />
          </a>
        </div>
                ...
                <div className="space-y-2 py-6">
                  <Disclosure as="div" className="-mx-3">
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-normal leading-7
                        ...
                        <Disclosure.Panel className="mt-2 space-y-2">
                          {[...company].map((item) => (
                            <Disclosure.Button
                              ...
                              as="a"
                              href={item.href}
                              className="block rounded-lg py-2 pl-6 pr-3 text-sm font-normal leading-7 text-white font-poppins  antialiased"
                            >
                              {item.name}
                            </Disclosure.Button>
                          ))}
                    ...
                    <div className="-my-6 divide-y divide-gray-500/10">
                      <div className="space-y-2 py-6">
                        <Disclosure as="div" className="-mx-3">
                          {({ open }) => (
                            <>
                              <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-normal leading-7 text-white font-poppins focus:bg-[#0A0A0A] antialiased">
                                Services
                                <ChevronDownIcon
                                  className={classNames(
                                    open ? "rotate-180" : "",
                  ...
                  <a
                    href="/hire-dev"
                    className="-mx-3 block rounded-lg px-3 py-2 text-base font-normal leading-7 text-white font-poppins hover:bg-[#0A0A0A] antialiased"
                  >
                    Hire developers
                  </a>
                  <a
