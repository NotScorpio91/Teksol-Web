        ...
        <div className='flex justify-center items-center mt-40 '>
            <div className='bg-[#0A0A0A] w-[1200px] px-1 rounded-md flex flex-col'>
                ...
                <div className="Heading flex flex-col gap-4 py-6 px-4 ">
                    <h1 className='text-white font-poppins font-bold text-4xl '>{heading}</h1>
                    <p className='text-[#9E9E9E] text-base font-poppins'>{title}</p>
                </div>
                ...
                <div className="Dis flex flex-col justify-center  gap-6 px-4  pb-10 pt-12">
                    ...
                    <div className=" flex flex-col gap-8 ">
                        <h1 className='text-white font-poppins text-3xl font-semibold'>{distitle}</h1>
                        <p className='text-[#9E9E9E] text-base font-poppins leading-6'>{dis}
                        </p>
