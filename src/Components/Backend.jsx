...
import Yii from '../assets/svg/yii.svg'
import CakePHP from '../assets/svg/cakephp.svg'
import Java from '../assets/svg/java.svg'
import WindowsDotNet from '../assets/svg/windows-dotnet.svg'
import CSharp from '../assets/svg/csharp.svg'
import RubyonRails from '../assets/svg/ruby-on-rails.svg'
import Codeelgniter from '../assets/svg/codeigniter.svg'
import Python from '../assets/svg/python.svg'
import Laravel from '../assets/svg/laravel.svg'
import Scala from '../assets/svg/scala.svg'
import Symfony from '../assets/svg/symfony.svg'
import Zend from '../assets/svg/zend.svg'
import NodeJS from '../assets/svg/nodejs.svg'
import Django from '../assets/svg/django.svg'
import GraphQL from '../assets/svg/graphqlapi.svg'
import Parse from '../assets/svg/parse.svg'
        ...
        <div>
            <div className='grid grid-cols-6 justify-center items-center text-center gap-14 text-white font-inter'>
                ...
                <div className='flex flex-col justify-center items-center gap-2 '>
                    ...
                    <img className='w-[50px] h-[50px]' src={RubyonRails} alt="" />
                    <h1>Ruby on Rails</h1>
