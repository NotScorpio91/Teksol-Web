  ...
  return (
    <div className='flex justify-center items-center mt-16  '>
      ...
      <BiMessageDetail size={100} />
        <h1 className='text-white font-semibold font-poppins antialiased '>IT Consultancy</h1>
    ...
    <div className='text-white my-5 transition-all   hover:scale-105 hover:transition-all cursor-pointer '>
      ...
      <TbDeviceDesktopAnalytics size={100} />
        <h1 className='text-white font-semibold font-poppins antialiased '>Web Development</h1>
    ...
    <div className='text-white my-5 transition-all   hover:scale-105 hover:transition-all cursor-pointer ' >
      ...
      <HiMiniDevicePhoneMobile size={100} />
        <h1 className='text-white font-semibold font-poppins antialiased '>Mobile App</h1>
