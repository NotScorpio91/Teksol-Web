...
function AboutUs() {
    const accordion = [
        {
            title: 'Our Mission',
            text: 'Our mission is to provide cutting-edge technology solutions to our clients, helping them to achieve their business goals.',
        },
    ]
                ...
                <div className="flex  justify-center items-center">
                    <div className="LHS flex flex-col gap-7 py-4  sm:w-full">
                        ...
                        <p className="dark:text-[#9E9E9E] text-gray-500 sm:text-base text-sm ">
                            We are TEKSOL, a leading IT solutions provider. With
                            expertise in software consultancy and development,
                            we deliver tailored solutions using Laravel, Django,
                            React, and Vue.js. Trusted by clients worldwide, we
                            have successfully completed 100+ projects and offer
                            outsourcing services. Our customer-centric approach
                            ensures seamless collaboration, enabling us to
                            understand your unique needs and deliver exceptional
                            results. Experience innovation, integrity, and
                            excellence with TEKSOL, your partner for
                            transformative technology solutions. Contact us
                            today to discuss your project and unlock your
                        ...
                        <h2 className="dark:text-[#9E9E9E] text-gray-500 ">
                            ...
                            - Empowering Businesses through Innovative IT
                            Solutions.
                        </h2>
                    </div>
                ...
                <a href="https://calendly.com/darkcoderse/30min?month=2023-11">
                    <div className="flex shadow-xl bg-gray-50 text-black w-full   border dark:border-primary-black dark:hover:border-gray-600 rounded-none border-gray-300 hover:border-gray-400 justify-center flex-col items-center p-10 gap-5 font-poppins text-center select-none group dark:bg-gradient-to-r dark:from-primary-black dark:to-black dark:text-white">
                        <div className="flex flex-col justify-center items-center  ">
                            <FaCalendarDays
                                className="mb-7 text-black dark:text-white"
                                size={100}
                            />
                            ...
                            <p className="dark:text-[#9E9E9E] text-gray-500 text-sm  group-hover:bg-gradient-to-r from-[#00c6ff] to-[#92EFFD] group-hover:text-transparent group-hover:bg-clip-text group-transition-all cursor-pointer  ">
                                30 Mint Meeting where we disucess about your
                                business problems
                            </p>
                        </div>
                    </div>
