            ...
            <div
                ...
                <div className="w-[720px]  ">
                    ...
                    <div className="flex flex-col justify-center items-start sm:pt-60 pt-28  max-w-screen-xl">
                        <h1 className="text-[#FFF] font-poppins sm:text-7xl text-4xl sm:leading-[80px] font-black cursor-text  text-start antialiased">
                            SENIOR SOFTWARE ENGINEER DEVELOPER ENVIRONMENTS
                        </h1>
                        <p className="text-gray-100 font-poppins text-sm sm:text-2xl font-medium sm:leading-7 pb-12 sm:pb-14 text-start antialiased">
                            San Francisco, CA or Remote (U.S.)
                        </p>
                        <p className="text-gray-100 font-poppins text-sm sm:text-base sm:leading-7   text-start antialiased">
                        ...
                        <p className="text-gray-100 font-poppins text-sm sm:text-base sm:leading-7  pb-14 text-start antialiased">
                    ...
                    <div>
                        {aboutlist.map(item => (
                            <div key={aboutlist}>
                                <h3 className="text-gray-100 font-poppins text-sm sm:text-xl font-medium sm:leading-7 pb-12 sm:pb-4 text-start antialiased">
                                    {item.heading}
                                </h3>
                                <p className="text-gray-100 font-poppins text-sm sm:text-sm sm:leading-7 list-item ml-5  pb-14 text-start antialiased">
                                    {item.list}
                                </p>
                                <p className="text-gray-100 font-poppins text-sm sm:text-sm sm:leading-7  pb-14 text-start antialiased">
                                    {item.des}
                                </p>
                            </div>
                        ))}
                    ...
                    <div className="bg-[#151515] mt-16 sm:mt-14  sm:mb-52 font-poppins ">
                        <div>
                            <h2 className=" sm:text-5xl text-3xl tracking-tight font-semibold    text-[#FFF]  antialiased ">
                                APPLY FOR THIS JOB
                            </h2>
                        </div>
                                ...
                                <form action="#" className="grid grid-cols-2">
                                    <div className="px-1 sm:col-span-1 col-span-2 ">
                                        ...
                                        <input
                                            type="text"
                                            id="name"
                                            className="shadow-sm bg-[#0A0A0A]  text-white text-sm rounded-[5px]  block w-full  py-[12px] px-[14px] placeholder-[#9E9E9E] focus:outline focus:outline-1 focus:outline-white outline-none  antialiased "
                                    ...
                                    <div className="col-span-2 mb-9 px-1">
                                        ...
                                        <textarea
                                            id="message"
                                            rows="6"
                                            className="block  py-[12px] px-[14px] h-[120px] w-full  bg-[#0A0A0A] text-white rounded-[5PX]  placeholder-[#9E9E9E]  antialiased text-sm outline-none focus:outline focus:outline-1 focus:outline-white "
