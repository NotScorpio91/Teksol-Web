...
function Cards() {
    ...
    return (
        <div className="flex justify-center items-center sm:pt-24 mx-4 sm:px-4 font-inter">
            <div className="sm:w-[1280px]  space-y-8">
                <div className=" pb-6  text-left">
                    <h1 className="text-[#FFF] uppercase  sm:text-3xl text-lg sm:w-fit cursor-text antialiased bg-gradient-to-r from-[#00c6ff] to-[#92EFFD] text-transparent bg-clip-text hover: ">
                        What we do
                    </h1>
                    <p className="text-white  text-xs sm:text-[18px] font-extralight sm:leading-[28px] sm:w-[980px] mt-6 sm:h-[66px] cursor-text antialiased">
