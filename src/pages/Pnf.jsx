    ...
    <>
      ...
      <div 
        ...
        <div className="text-center relative bottom-52 sm:bottom-60">
          <p className="relative top-9 text-transparent bg-clip-text antialiased font-poppins text-5xl bg-gradient-to-r dark:from-[#00c6ff] dark:to-[#92EFFD]">404</p>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="/"
              className="dark:text-black text-white dark:bg-gradient-to-r   font-medium rounded-md text-sm px-[30px] py-3 text-center  font-poppins antialiased transition-all active:scale-95 bg-gradient-to-r dark:from-[#00c6ff] dark:to-[#92EFFD]"
            >
              Go back home
            </a>
          </div>
